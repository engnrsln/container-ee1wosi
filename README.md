...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ee1wosi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ee1wosi.containers.anotherwebservice.com/
...
```
git clone git@github.com:engnrsln/container-ee1wosi.git
cd container-ee1wosi
```
...
```
docker attach container-ee1wosi
```
